...
const Posts = (props) => {
  ...
  const hasLiked = (post, user) => {
    ...
    console.log(post,'pppppppppppppp');
  ...
  const toggleLike = async (post) => {
    ...
    console.log(updatedPost,"updatedPostupdatedPost");
  ...
  const renderItems = (item) => {
    ...
    return <Post post={post} toggleLike={toggleLike} toggleFollow={toggleFollow} onItemClicked={onItemClicked} isFollowHidden={user && user.id === post.author.id} navigation={navigation} />;
  };
